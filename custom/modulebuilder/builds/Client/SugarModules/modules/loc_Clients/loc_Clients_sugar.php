 ...
 * PLACE ANY CUSTOMIZATIONS IN loc_Clients
 */

require_once('include/SugarObjects/templates/company/Company.php');

class loc_Clients_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'loc_Clients';
	var $object_name = 'loc_Clients';
	var $table_name = 'loc_clients';
