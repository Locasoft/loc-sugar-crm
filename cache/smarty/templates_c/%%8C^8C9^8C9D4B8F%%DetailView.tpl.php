<?php /* Smarty version 2.6.11, created on 2016-01-28 09:02:37
         compiled from cache/modules/loc_Clients/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/loc_Clients/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/loc_Clients/DetailView.tpl', 38, false),array('function', 'sugar_translate', 'cache/modules/loc_Clients/DetailView.tpl', 47, false),array('function', 'sugar_phone', 'cache/modules/loc_Clients/DetailView.tpl', 76, false),array('modifier', 'strip_semicolon', 'cache/modules/loc_Clients/DetailView.tpl', 48, false),array('modifier', 'substr', 'cache/modules/loc_Clients/DetailView.tpl', 102, false),array('modifier', 'to_url', 'cache/modules/loc_Clients/DetailView.tpl', 104, false),array('modifier', 'escape', 'cache/modules/loc_Clients/DetailView.tpl', 412, false),array('modifier', 'url2html', 'cache/modules/loc_Clients/DetailView.tpl', 412, false),array('modifier', 'nl2br', 'cache/modules/loc_Clients/DetailView.tpl', 412, false),array('modifier', 'strip_tags', 'cache/modules/loc_Clients/DetailView.tpl', 417, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='loc_Clients'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='loc_Clients'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='loc_Clients'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='loc_Clients'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<div id="loc_Clients_detailview_tabs"
>
<div >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['phone_alternate']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_OTHER_PHONE','module' => 'loc_Clients'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  class="phone">
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['loc_clients_type']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'loc_Clients'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['loc_clients_type']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['loc_clients_type']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['loc_clients_type']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['loc_clients_type']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['loc_clients_type']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['loc_clients_type']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['loc_clients_type']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['loc_clients_type']['options'][$this->_tpl_vars['fields']['loc_clients_type']['value']]; ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['date_entered']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'loc_Clients'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['shipping_address_street']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_ADDRESS','module' => 'loc_Clients'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
