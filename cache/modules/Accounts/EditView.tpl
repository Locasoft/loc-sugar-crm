...
{capture name="label" assign="label"}{sugar_translate label='LBL_RAISON_SOCIALE' module='Accounts'}{/capture}
...
{if strlen($fields.raison_sociale_c.value) <= 0}
{assign var="value" value=$fields.raison_sociale_c.default_value }
{else}
{assign var="value" value=$fields.raison_sociale_c.value }
{/if}  
<input type='text' name='{$fields.raison_sociale_c.name}' 
id='{$fields.raison_sociale_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      accesskey='7'  >
<td valign="top" id='cp_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_CP' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ECHEANCE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.echeance_c.value) <= 0}
{assign var="value" value=$fields.echeance_c.default_value }
{else}
{assign var="value" value=$fields.echeance_c.value }
{/if}  
<input type='text' name='{$fields.echeance_c.name}' 
id='{$fields.echeance_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
{if strlen($fields.fax_c.value) <= 0}
{assign var="value" value=$fields.fax_c.default_value }
{else}
{assign var="value" value=$fields.fax_c.value }
{/if}  
<input type='text' name='{$fields.fax_c.name}' 
id='{$fields.fax_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_RESPONSABLE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.responsable_c.value) <= 0}
{assign var="value" value=$fields.responsable_c.default_value }
{else}
{assign var="value" value=$fields.responsable_c.value }
{/if}  
<input type='text' name='{$fields.responsable_c.name}' 
id='{$fields.responsable_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='portable_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_PORTABLE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.portable_c.value) <= 0}
{assign var="value" value=$fields.portable_c.default_value }
{else}
{assign var="value" value=$fields.portable_c.value }
{/if}  
<input type='text' name='{$fields.portable_c.name}' 
id='{$fields.portable_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_VILLE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.ville_c.value) <= 0}
{assign var="value" value=$fields.ville_c.default_value }
{else}
{assign var="value" value=$fields.ville_c.value }
{/if}  
<input type='text' name='{$fields.ville_c.name}' 
id='{$fields.ville_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='mail_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_MAIL' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{/if}  
<input type='text' name='{$fields.sigle_c.name}' 
id='{$fields.sigle_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='telephone_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_TELEPHONE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.telephone_c.value) <= 0}
{assign var="value" value=$fields.telephone_c.default_value }
{else}
{assign var="value" value=$fields.telephone_c.value }
{/if}  
<input type='text' name='{$fields.telephone_c.name}' 
id='{$fields.telephone_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_LIBELLE_INTERNE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.libelle_interne_c.value) <= 0}
{assign var="value" value=$fields.libelle_interne_c.default_value }
{else}
{assign var="value" value=$fields.libelle_interne_c.value }
{/if}  
<input type='text' name='{$fields.libelle_interne_c.name}' 
id='{$fields.libelle_interne_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='adresse_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_ADRESSE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.adresse_c.value) <= 0}
{assign var="value" value=$fields.adresse_c.default_value }
{else}
{assign var="value" value=$fields.adresse_c.value }
{/if}  
<input type='text' name='{$fields.adresse_c.name}' 
id='{$fields.adresse_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
addToValidate('EditView', 'adresse_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ADRESSE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'cp_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CP' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'echeance_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ECHEANCE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'fax_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_FAX' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'id_lims_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ID_LIMS' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'libelle_interne_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_LIBELLE_INTERNE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'mail_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_MAIL' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'portable_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_PORTABLE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'raison_sociale_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_RAISON_SOCIALE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'responsable_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_RESPONSABLE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'sigle_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SIGLE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'telephone_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TELEPHONE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'ville_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_VILLE' module='Accounts' for_js=true}{literal}' );
